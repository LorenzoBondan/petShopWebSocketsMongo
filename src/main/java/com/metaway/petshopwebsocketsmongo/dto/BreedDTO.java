package com.metaway.petshopwebsocketsmongo.dto;
...
public class BreedDTO {
    ...
    public BreedDTO(String id, String description) {
        this.id = id;
        this.description = description;
    }

    public BreedDTO(String id, String description, Boolean deleted, String createdBy, LocalDateTime creationDate, String lastUpdatedBy, LocalDateTime lastUpdatedDate) {
        this.id = id;
        this.description = description;
